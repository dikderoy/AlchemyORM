...
{
	/**
	 * link to active[used by this query] connection PDO object
	 * @var \PDO
	 */
	protected $pdo = null;
	/**
	...
	/**
	 * returns PDO connection object for direct use
	 * @return \PDO
	 */
	...
	/**
	 * constructor - sets used connection PDO object,
	 * if $pdo not provided - invoke Db::getPDO() - to receive global connection
	 *
	 * @param null|\PDO $pdo - [optional - used connection]
	 */
	...
	public function selectMode($line)
	{
		$this->modifier = $line;
	}
	...
	public function whereComplex($condition, array $args = null)
	{
		...
		$this->whereValueSet = ($args)?$args:array();
		return $this;
	}
